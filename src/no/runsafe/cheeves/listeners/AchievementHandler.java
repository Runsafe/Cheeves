...
public class AchievementHandler implements IPluginEnabled
{
	...
	public void awardAchievement(IAchievement achievement, IPlayer player)
	{
		this.awardAchievement(achievement, player, false);
	}

	public void awardAchievement(IAchievement achievement, IPlayer player, boolean serverFirst)
	{
	...
	public void announceAchievement(IAchievement achievement, IPlayer player)
	{
	...
	public boolean hasAchievement(IPlayer player, IAchievement achievement)
	{
