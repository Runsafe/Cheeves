...
public class MyPrecious extends AchievementDefinition implements IInventoryClick, IPlayerPickupItemEvent
{
	public MyPrecious(AchievementDefinitionRepository repository, AchievementHandler achievementHandler)
	{
