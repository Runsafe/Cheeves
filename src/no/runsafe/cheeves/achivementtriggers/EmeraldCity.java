...
public class EmeraldCity extends AchievementDefinition implements IInventoryClick, IPlayerPickupItemEvent
{
	public EmeraldCity(AchievementDefinitionRepository repository, AchievementHandler achievementHandler)
	{
